            ...
            {this.state.outings.map((outing, index) =>{
              return (
                  <tr key={index}>
                    ...
                    <td className="centered"><Button href='../feed' id={outing.id} onClick={this.handleDeleteClick.bind(this)} className="centered" bsSize="small" bsStyle="danger">Delete</Button></td>
                  </tr>
              )
            })}
